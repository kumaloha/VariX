...
func TestBuildQwen36RequestBuildsMultimodalPayload(t *testing.T) {
	...
	req, err := varixllm.BuildQwen36ProviderRequest(varixllm.Qwen36PlusModel, bundle, "Summarize this content.", bundle.TextContext())
	if err != nil {
...
func TestFileToDataURL(t *testing.T) {
	...
	got, err := varixllm.FileToDataURL(path)
	if err != nil {
