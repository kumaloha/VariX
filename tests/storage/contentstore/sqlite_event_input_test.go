...
func TestSQLiteStore_BuildEventInputCandidatesFromMemoryContentGraphs(t *testing.T) {
	...
	sg1 := model.ContentSubgraph{
		...
		Nodes: []model.ContentNode{
			{ID: "d1", SourceArticleID: "unit-1", SourcePlatform: "twitter", SourceExternalID: "a1", RawText: "美联储加息0.25%", SubjectText: "美联储", ChangeText: "加息0.25%", Kind: model.NodeKindObservation, GraphRole: model.GraphRoleDriver, IsPrimary: true, VerificationStatus: model.VerificationPending, TimeBucket: "1w"},
			{ID: "t1", SourceArticleID: "unit-1", SourcePlatform: "twitter", SourceExternalID: "a1", RawText: "未来一周美股承压", SubjectText: "美股", ChangeText: "承压", Kind: model.NodeKindPrediction, GraphRole: model.GraphRoleTarget, IsPrimary: true, VerificationStatus: model.VerificationPending, TimeBucket: "1w"},
		},
	}
	sg2 := model.ContentSubgraph{
		...
		UpdatedAt:        now.Format(time.RFC3339),
		Nodes: []model.ContentNode{
			{ID: "d2", SourceArticleID: "unit-2", SourcePlatform: "twitter", SourceExternalID: "a2", RawText: "联储继续收紧", SubjectText: "美联储", ChangeText: "继续收紧", Kind: model.NodeKindObservation, GraphRole: model.GraphRoleDriver, IsPrimary: true, VerificationStatus: model.VerificationPending, TimeBucket: "1w"},
			{ID: "t2", SourceArticleID: "unit-2", SourcePlatform: "twitter", SourceExternalID: "a2", RawText: "最近一周美股回撤", SubjectText: "美股", ChangeText: "回撤", Kind: model.NodeKindObservation, GraphRole: model.GraphRoleTarget, IsPrimary: true, VerificationStatus: model.VerificationPending, TimeBucket: "1w"},
		},
	}
