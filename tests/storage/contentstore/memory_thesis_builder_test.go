	...
	nodes := []memory.AcceptedNode{
		{
			...
			SourceExternalID: "S1",
			NodeID:           "n1",
			NodeKind:         string(model.NodeConclusion),
			NodeText:         "石油美元回流正在削弱",
			AcceptedAt:       now,
		},
		{
	...
	nodes := []memory.AcceptedNode{
		{
			...
			SourceExternalID: "S1",
			NodeID:           "n1",
			NodeKind:         string(model.NodeImplicitCondition),
	...
	nodes := []memory.AcceptedNode{
		{
			...
			SourceExternalID: "S1",
			NodeID:           "n1",
			NodeKind:         string(model.NodeFact),
			NodeText:         "流动性收紧",
			AcceptedAt:       now,
		},
		{
...
func TestBuildCandidateTheses_KeepsSameSourceTransmissionBridgeWithEvidenceAndClaim(t *testing.T) {
	...
	nodes := []memory.AcceptedNode{
		...
		},
		{
			...
			SourceExternalID: "G04",
			NodeID:           "n2",
			NodeKind:         string(model.NodeMechanism),
...
func TestBuildCandidateTheses_DoesNotOvermergeLargeSingleSourceMemory(t *testing.T) {
	now := time.Date(2026, 4, 15, 0, 0, 0, 0, time.UTC)
	nodes := []memory.AcceptedNode{
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "BIG1", NodeID: "n1", NodeKind: string(model.NodeFact), NodeText: "流动性收紧", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "BIG1", NodeID: "n2", NodeKind: string(model.NodeConclusion), NodeText: "风险资产承压", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "BIG1", NodeID: "n3", NodeKind: string(model.NodePrediction), NodeText: "未来数月波动加大", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "BIG1", NodeID: "n4", NodeKind: string(model.NodeFact), NodeText: "银行去监管推进", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "BIG1", NodeID: "n5", NodeKind: string(model.NodeConclusion), NodeText: "金融体系更安全", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "BIG1", NodeID: "n6", NodeKind: string(model.NodePrediction), NodeText: "经济增长改善", AcceptedAt: now},
	}
	...
	nodes := []memory.AcceptedNode{
		{
			...
			SourceExternalID: "S1",
			NodeID:           "n1",
			NodeKind:         string(model.NodeExplicitCondition),
...
func TestBuildCandidateTheses_CompressesLargePetrodollarPrivateCreditTopicLabel(t *testing.T) {
	now := time.Date(2026, 4, 15, 0, 0, 0, 0, time.UTC)
	nodes := []memory.AcceptedNode{
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n1", NodeKind: string(model.NodeFact), NodeText: "1970年代美沙达成石油美元协议，形成中东石油收入回流购买美国金融资产的闭环", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n2", NodeKind: string(model.NodeImplicitCondition), NodeText: "私募信贷基金通过监管套利进行期限错配，积累流动性隐患", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n3", NodeKind: string(model.NodeConclusion), NodeText: "石油美元循环面临断裂风险，且私募信贷正积累类似2008年次贷危机的流动性隐患", AcceptedAt: now},
	}
...
func TestBuildCandidateTheses_ReattachesSameSourceSingletonConditionAndPrediction(t *testing.T) {
	...
	nodes := []memory.AcceptedNode{
		...
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n2", NodeKind: string(model.NodeImplicitCondition), NodeText: "私募信贷基金通过监管套利进行期限错配，积累流动性隐患", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n3", NodeKind: string(model.NodeConclusion), NodeText: "石油美元循环面临断裂风险，且私募信贷正积累类似2008年次贷危机的流动性隐患", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n4", NodeKind: string(model.NodeExplicitCondition), NodeText: "若AI应用冲击导致SaaS企业现金流断裂", AcceptedAt: now},
		{UserID: "u-thesis", SourcePlatform: "weibo", SourceExternalID: "Q1", NodeID: "n5", NodeKind: string(model.NodePrediction), NodeText: "一旦私募信贷触发季度赎回上限，下季度极大概率发生全面挤兑并波及华尔街", AcceptedAt: now},
	}
