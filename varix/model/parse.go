...
func ParseOutput(raw string) (Output, error) {
	...
	_ = json.Unmarshal(payload["primaryView"], &out.PrimaryView)
	...
	_ = json.Unmarshal(payload["digest"], &out.Digest)
	_ = json.Unmarshal(payload["coverage_audit"], &out.CoverageAudit)
	_ = json.Unmarshal(payload["visibleCoverageAudit"], &out.VisibleCoverageAudit)
	_ = json.Unmarshal(payload["inventoryCoverageAudit"], &out.InventoryCoverageAudit)
