...
type ContentNodeKind string

const (
	NodeKindObservation ContentNodeKind = "observation"
	NodeKindPrediction  ContentNodeKind = "prediction"
)
...
type ContentNode struct {
	...
	Kind               ContentNodeKind     `json:"kind"`
...
func (n ContentNode) Validate() error {
