...
func stage1Extract(ctx context.Context, rt runtimeChat, model string, bundle Bundle) (graphState, error) {
...
func stage1Refine(ctx context.Context, rt runtimeChat, model string, bundle Bundle, state graphState) (graphState, error) {
...
func stage1Aggregate(ctx context.Context, rt runtimeChat, model string, bundle Bundle, state graphState) (graphState, error) {
	state = normalizeStage1State(state)
	if len(state.Nodes) == 0 {
		return state, nil
	}
