...
func runValidatePreview(ctx context.Context, rt runtimeChat, model string, bundle compile.Bundle, state graphState, maxRounds int, paragraphLimit int) (graphState, error) {
	if maxRounds <= 0 {
		return state, nil
	}
