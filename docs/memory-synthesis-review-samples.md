# Memory Synthesis Review Samples

This document captures representative **human-readable** `memory global-synthesis-card`
shapes so the synthesis memory output can be reviewed without reading raw
JSON.
