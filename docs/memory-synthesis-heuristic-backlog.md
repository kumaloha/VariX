# Memory Synthesis Heuristic Backlog

This document captures the highest-value heuristic improvements still worth
doing after the synthesis memory review system became feature-complete.
...
- annotate synthesis entries with originating thesis ids
...
### Success signal
Reviewers can tell not only that cluster and synthesis differ, but *how* they differ.
