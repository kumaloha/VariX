# VariX Memory synthesis Go Types 草案
...
### 4.14 GlobalMemorySynthesisOutput

```go
type GlobalMemorySynthesisOutput struct {
...
1. Keep existing cluster-first types intact during migration.
2. Add synthesis types additively before deleting old thesis-first types.
